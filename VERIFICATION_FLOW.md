...
}
{
  "success": false,
  "error": {
    "message": "Too many incorrect attempts. Wait 15 minutes",
    "code": 400
  }
}
```
...
Response 400:
{
  "success": false,
  "error": {
    "message": "Wait 60 seconds before resending",
    "code": 400
  }
}
{
...
**Mobile Handling**:
- **204**: Show "Code sent" toast, start 60s countdown on resend button, new code replaces the previous one
- **400 (cooldown)**: Disable resend button, show countdown timer (60 seconds remaining)
