...
var (
	...
	ErrVerificationLocked       = errors.New("too many incorrect attempts")
	ErrVerificationCooldown     = errors.New("wait before resending")
	ErrVerificationCodePending  = errors.New("code already sent, please wait")
)
