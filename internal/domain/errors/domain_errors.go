...
var (
	...
	ErrAccountNotConfirmed    = errors.New("account not confirmed, please check your email")
	ErrEmailNotVerified       = errors.New("email not verified, please check your email")
