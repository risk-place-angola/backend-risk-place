...
func (m *MockUserRepository) FindAllUserWarnings() ([]*model.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindWarningByUserID(id string) ([]*model.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Save(entity *model.User) error {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Update(entity *model.User) error {
	m.ctrl.T.Helper()
